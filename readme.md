...
It uses a mex file solving the Fokker-Planck equation developed in the Kiani lab. The mex file is included in this repository. The source code is available at [https://github.com/KianiLab/FokkerPlanck](https://github.com/KianiLab/FokkerPlanck). 
